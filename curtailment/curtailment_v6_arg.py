...
def energy_loss_analysis(df_all_redistrib: pd.DataFrame, output_folder: str,
    ...
    df['Energy Original'] = df_all_redistrib['Energy Original']
    df['Curt Original'] = df_all_redistrib['Curtailment Original']
    df['Curt Adicional 1'] = df_all_redistrib['Curtailment Adicional 1']
    df['Curt Adicional 2'] = df_all_redistrib['Curtailment Adicional 2']
    df['Curt Total'] = df['Curt Original'] + df['Curt Adicional 1'] + \
        df['Curt Adicional 2']
    df['Redist Energy'] = df_all_redistrib['Redistributed Energy']
    df['Redist Curt'] = df_all_redistrib['Redistributed Curtailment']
    df['Delta Energy'] = \
        (df['Redist Energy'] - df['Energy Original'] +
         df['Curt Adicional 1'] + df['Curt Adicional 2'])
    df['Delta Curt'] = \

...
def get_all_profiles_plexos(df_monthly_demand: pd.DataFrame,
    ...
    with concurrent.futures.ThreadPoolExecutor() as executor:
        ...
        for year in list_of_years:
            futures.append(executor.submit(process_year, year))

...
def enter_data():
    ...
    if accepted == "Accepted":
        ...
        logger.warning("You have not accepted the terms")
        messagebox.showwarning(
...
if __name__ == "__main__":
    ...
    add_file_handler(logger, 'log_interface', Path.cwd())
    ...
    numsemesters_label = tk.Label(
        courses_frame, text="# Semesters")
    numsemesters_spinbox = tk.Spinbox(
        courses_frame, from_=0, to="infinity")
